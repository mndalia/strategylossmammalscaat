...
mermaid("
graph LR
A(Mamíferos da Caatinga)-->B(Estratégias Ecológicas)
B-->C{Mamiferos Caçados}
C-->D(Estrategia Rara)
C-->E(Estrategia Comum)
D-- + Caçada ---F[Criticamente Ameaçada]
D-- - Caçada ---G[Ameaçada]
E-- + Caçada ---H[Vulneravel]
E-- - Caçada ---I[Livre de Riscos]

 subgraph - Chance de Substituição
    D
    end
...
### 5.1 instalando e iniciando pacotes

```{r pacotes, echo=TRUE, eval=FALSE}
 #Packages ----------------------------------------------------------------
...
### 5.2 Carregando dados

```{r dados, echo=FALSE, include=FALSE, eval=TRUE}
#Carregando os dados----
